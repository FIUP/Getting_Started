...
### LOGICA
 - *Manuale pratico di Logica*, Maria Emilia Maietti, Padova, 2016 dispense.
 - *Per istruire un robot*, Giovanni Sambin, Libreria Cortina, Padova, 2007.

### SISTEMI OPERATIVI
 - *I moderni sistemi operativi (4rd Edition)*, Andrew S. Tanenbaum, Pearson, 2016.
...
### CALCOLO NUMERICO
- *Calcolo Numerico: Metodi ed Algoritmi* (4th Edition), Michela Redivo Zaglia, Libreria Progetto Padova, 2011.
- *Calcolo Numerico: Esercizi* (3rd Edition), Michela Redivo Zaglia, Libreria Progetto Padova, 2015.
 - *Quaderno MATLAB*, Michela Redivo Zaglia, Libreria Progetto Padova, 2015.


### PROBABILITA' E STATISTICA
 - *Appunti di Probabilità*, Lorenzo Finesso, Libreria Progetto Padova, 2015.

### PROGRAMMAZIONE AD OGGETTI
 - *Appunti di programmazione ad oggetti*, Francesco Ranzato, Libreria Progetto Padova, Padova, 2012.
